...
public class XmlUtilTest {
    ...
    private static final String VALID_EMAIL = "hansexample";
    ...
    public void getDataFromFile_validFile_validResult() throws Exception {
        ProductDatabase dataFromFile = XmlUtil.getDataFromFile(VALID_FILE, XmlSerializableProductDatabase.class).toModelType();

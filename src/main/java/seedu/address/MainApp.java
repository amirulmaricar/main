...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing ProductDatabase ]===========================");
        super.init();
        ...
        ProductDatabaseStorage productDatabaseStorage = new XmlProductDatabaseStorage(userPrefs.getProductDatabaseFilePath());
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        try {
            productDatabaseOptional = storage.readAddressBook();
            if (!productDatabaseOptional.isPresent()) {
                logger.info("Data file not found. Will be starting with a sample ProductDatabase");
            }
            initialData = productDatabaseOptional.orElseGet(SampleDataUtil::getSampleAddressBook);
        } catch (DataConversionException e) {
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting ProductDatabase " + MainApp.VERSION);
